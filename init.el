...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-lsp lsp-java lsp-javacomp lsp-javascript-typescript lsp-mode lsp-python lsp-rust lsp-ui company company-c-headers company-jedi company-web use-package helm helm-fuzzy-find helm-git helm-ls-git helm-ls-hg helm-ls-svn helm-swoop magit magit-filenotify magit-find-file magit-popup neotree yasnippet-snippets yasnippet toml-mode dockerfile-mode yaml-mode))))
(custom-set-faces
