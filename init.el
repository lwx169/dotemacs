...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (go-mode bison-mode htmlize org-roam-server org-roam io-mode web-mode base16-theme counsel-notmuch notmuch fill-column-indicator ivy-rich rust-mode python-mode flycheck keyfreq company-lsp lsp-java lsp-javacomp lsp-javascript-typescript lsp-mode lsp-python lsp-ui company company-c-headers company-jedi company-web use-package magit magit-filenotify magit-find-file magit-popup yasnippet yasnippet-snippets toml-mode dockerfile-mode yaml-mode lua-mode cmake-mode plantuml-mode ace-jump-mode calfw calfw-org treemacs lsp-treemacs treemacs-magit groovy-mode gradle-mode protobuf-mode projectile ivy counsel swiper counsel-projectile emacsql emacsql-sqlite)))
 '(setq nil t)
 '(yas-global-mode 1))
(custom-set-faces
